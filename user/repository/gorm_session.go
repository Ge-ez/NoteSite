...
func (sr *SessionGormRepo) Session(sessionID string) (*models.Session, []error) {
...
func (sr *SessionGormRepo) StoreSession(session *models.Session) (*models.Session, []error) {
	sess := session
...
func (sr *SessionGormRepo) DeleteSession(sessionID string) (*models.Session, []error) {
